...
const validationConfig = {
  formSelector: '.popup__form', inputSelector: '.popup__input', submitButtonSelector: '.popup__button',
  inactiveButtonClass: 'popup__button_disabled', inputErrorClass: 'popup__input_type_error', errorClass: 'popup__error_visible',
};
...
function handleFormProfileEditSubmit(e) {
  ...
  const data = {
    name: profileFormNameInput.value, about: profileFormDescriptionInput.value,
  };

  setLoading({
    buttonElement: profileFormSubmitButton, isLoading: true,
  });
  ...
  MestoAPI.updateProfile(data).then(({ name, about, avatar }) => {
    ...
    setLoading({
      buttonElement: profileFormSubmitButton, isLoading: false,
    });
  });
}
